...
function DeleteBook() {
    ...
    function deleteBook() {
        ...
        const deleteBk = () => {
            fetch(`https://63899fdd4eccb986e895a955.mockapi.io/books/${id}`,
                { method: "DELETE", headers: { "Content-Type": "application/json" }, body: JSON.stringify(book) })
    ...
    return (<>
        <h3>delete page {id}</h3>

        <form onSubmit={formik.handleSubmit} className="row form-container">
            <h4 className="form-title text-center">Delete Book Form</h4>
